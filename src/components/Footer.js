            ...
            <Toolbar>
                <Grid container sx={{ fontSize: '12px' }} rowSpacing={1}>
                    <Grid item sm={6} xs={12}>
                        <Typography>Copyright © 2022 Arnab Jana - All Rights Reserved</Typography>
                    </Grid>
                    <Grid item container sm={6} xs={12} rowSpacing={2} direction="column">
                        ...
                        <Grid item container columnSpacing={2}>
                            <Grid item>
                                <a href="https://www.linkedin.com/in/arnab-jana/"
                                    aria-label="linkedin"
                                    target="_blank"
                                    rel="noreferrer">
                            ...
                            <Grid item>
                                <a href="https://www.instagram.com/arnabfromjec05/"
                            ...
                            <Grid item>
                                <a href="https://twitter.com/arnabjana97/"
                                    aria-label="twitter"
                                    target="_blank"
                                    rel="noreferrer">
